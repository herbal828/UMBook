<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="padding: 100px 0 0 250px;">
			<div id="login-box">
				<h2>Um Book Login</h2>
				 Ingrese a continuacion su email y contrasena <br/>
				<br/>
				...
				<br/>
				<span class="login-box-options"><input type="checkbox" name="1" value="1">Recordar mi cuenta?<a href="#" style="margin-left:30px;">Registrarte</a></span>
				<br/>
				<br/>
